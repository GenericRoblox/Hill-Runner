  ...
  pickup: {
    ...
    tiers: {
      engine: [
        ...
        { name: '2.5L V6',       torque: 1.0, topSpeed: 85, cost: 2500 },
        { name: '3.5L V6 Turbo', torque: 1.2, topSpeed: 100, cost: 6500 },
      ],
      suspension: [
        { name: 'Stock Springs',  stiffness: 0.055, damping: 0.08, travel: 1.00, cost: 0 },
        { name: 'Heavy Duty',     stiffness: 0.070, damping: 0.10, travel: 1.05, cost: 600 },
        { name: 'Off-Road Kit',   stiffness: 0.085, damping: 0.13, travel: 1.10, cost: 1600 },
        { name: 'Pro Long-Travel',stiffness: 0.100, damping: 0.16, travel: 1.15, cost: 3600 },
      ],
      tires: [
        { name: 'Street',          grip: 0.85, cost: 0 },
        { name: 'All-Terrain',     grip: 1.00, cost: 500 },
        { name: 'Off-Road Knobby', grip: 1.15, cost: 1400 },
        { name: 'Racing Slick',    grip: 1.30, cost: 3200 },
      ],
      brakes: [
        { name: 'Stock Drums',    power: 1.0, cost: 0 },
        { name: 'Discs',          power: 1.3, cost: 500 },
        { name: 'Vented Discs',   power: 1.6, cost: 1300 },
        { name: 'Racing Calipers',power: 2.0, cost: 3000 },
      ],
    },
  },
  ...
  sports: {
    ...
    tiers: {
      engine: [
        ...
        { name: '3.0L V6',       torque: 0.90, topSpeed: 48, cost: 1000 },
        { name: '4.0L V8',       torque: 1.12, topSpeed: 55, cost: 2600 },
        { name: '4.0L V8 Turbo', torque: 1.60, topSpeed: 64, cost: 5500 },
      ],
      suspension: [
        { name: 'Stock Coils',    stiffness: 0.055, damping: 0.09, travel: 0.90, cost: 0 },
        { name: 'Sport Coils',    stiffness: 0.070, damping: 0.11, travel: 0.92, cost: 700 },
        { name: 'Coilovers',      stiffness: 0.105, damping: 0.14, travel: 0.94, cost: 1800 },
        { name: 'Track Package',  stiffness: 0.120, damping: 0.17, travel: 0.96, cost: 4000 },
      ],
      tires: [
        { name: 'Street',       grip: 0.90, cost: 0 },
        { name: 'Sport',        grip: 1.05, cost: 600 },
        { name: 'Semi-Slick',   grip: 1.20, cost: 1600 },
        { name: 'Racing Slick', grip: 1.38, cost: 3600 },
      ],
      brakes: [
        { name: 'Stock Discs',   power: 1.1, cost: 0 },
        { name: 'Sport Discs',   power: 1.4, cost: 600 },
        { name: 'Big Brake Kit', power: 1.8, cost: 1500 },
        { name: 'Carbon Ceramic',power: 2.2, cost: 3400 },
      ],
    },
  },
  ...
  bike: {
    ...
    tiers: {
      engine: [
        ...
        { name: '600cc Twin',    torque: 0.88, topSpeed: 65, cost: 2300 },
        { name: '1000cc Four',   torque: 1.25, topSpeed: 80, cost: 5000 },
      ],
      suspension: [
        { name: 'Stock Forks',    stiffness: 0.010, damping: 0.08, travel: 0.30, cost: 0 },
        { name: 'Trail Forks',    stiffness: 0.025, damping: 0.10, travel: 0.56, cost: 650 },
        { name: 'Enduro Kit',     stiffness: 0.040, damping: 0.13, travel: 0.82, cost: 1700 },
        { name: 'Factory MX',     stiffness: 0.070, damping: 0.16, travel: 1.00, cost: 3800 },
      ],
      tires: [
        { name: 'Street',     grip: 0.85, cost: 0 },
        { name: 'Dual-Sport', grip: 1.00, cost: 550 },
        { name: 'Knobby',     grip: 1.15, cost: 1500 },
        { name: 'Race Compound', grip: 1.32, cost: 3400 },
      ],
      brakes: [
        { name: 'Stock',        power: 1.0, cost: 0 },
        { name: 'Wave Rotors',  power: 1.35, cost: 550 },
        { name: 'Dual Discs',   power: 1.7, cost: 1400 },
        { name: 'Race Spec',    power: 2.1, cost: 3200 },
      ],
    },
  },
};
